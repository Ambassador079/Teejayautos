    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-8 xl:px-12 h-[70px] flex items-center justify-between">
          ...
          >
            <span
              className={`font-serif font-semibold text-[15px] tracking-wide transition-colors duration-400 ${scrolled ? "text-ink" : "text-white"}`}
            >
              Teejay × Miso
            </span>
            <span
              className={`font-sans text-[8.5px] tracking-[0.38em] uppercase mt-[2px] transition-colors duration-400 ${scrolled ? "text-gold" : "text-gold-light"}`}
            >
              Premium Autos
            </span>
          </button>
