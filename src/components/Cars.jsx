    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            Every car in our collection is maintained to the highest standard —
          ...
          {CARS.map((car) => (
            ...
            >
              ...
              <div className="p-5 border-b border-gold/20">
                <h3 className="font-serif font-semibold text-ink text-[17px] leading-snug mb-2">
                  {car.name}
                </h3>
                <p className="font-mono text-stone text-sm leading-relaxed">
                  {car.desc}
                </p>
              </div>
            </motion.article>
