...
const waUrl = (b) =>
  `https://wa.me/${b.whatsapp}?text=${encodeURIComponent(b.whatsappMsg)}`;
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="absolute left-6 sm:left-14 top-1/4 h-32 w-px bg-gradient-to-b from-transparent via-gold/50 to-transparent"
      />
      <div
        aria-hidden
        className="absolute right-6 sm:right-14 bottom-32 h-20 w-px bg-gradient-to-b from-transparent via-gold/35 to-transparent"
      />
        ...
        <div className="w-full max-w-7xl mx-auto px-6 sm:px-10 xl:px-16 pb-20 sm:pb-28">
          <motion.div variants={stagger} initial="hidden" animate="show">
            ...
            <motion.div variants={up} className="flex items-center gap-3 mb-7">
              ...
              <span className="font-sans text-[10px] tracking-[0.4em] uppercase text-gold-light">
                {BRAND.location}
              </span>
            </motion.div>
            ...
            <motion.h1
              variants={up}
              className="font-serif font-bold text-white leading-[1.04] mb-8"
              style={{ fontSize: "clamp(2.6rem, 6vw, 5.4rem)" }}
            >
              Arrive in Style.
              <br />
              <em className="text-gold-light font-semibold not-italic">
                Move with Power.
              </em>
            </motion.h1>
            ...
            <motion.div variants={up} className="flex gap-10 mt-14">
              {[
                ...
                <div key={l}>
                  ...
                  <div className="font-sans text-[9px] tracking-[0.35em] uppercase text-white/40 mt-1">
                    {l}
                  </div>
                </div>
              ))}
      ...
      <motion.div
        ...
        aria-hidden
      >
        <span className="font-sans text-[8px] tracking-[0.45em] uppercase text-white/35">
          Scroll
        </span>
        <motion.div
          animate={{ y: [0, 8, 0] }}
