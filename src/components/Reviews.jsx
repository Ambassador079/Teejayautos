...
export default function Reviews() {
  ...
  const prev = useCallback(() => {
    setDir(-1);
    setCur((c) => (c - 1 + REVIEWS.length) % REVIEWS.length);
  }, []);
  ...
  return (
    <section
      id="reviews"
      className="py-24 lg:py-36 bg-ink px-5 sm:px-8 xl:px-12 overflow-hidden"
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          >
            Words from Our{" "}
            <em className="text-gold-light font-normal italic">Clients</em>
          </h2>
        </motion.div>
        ...
        >
          <div
            aria-hidden
            className="absolute -top-8 -left-2 font-serif text-[110px] leading-none text-gold/8 select-none pointer-events-none"
          >
            "
          </div>
          ...
          <AnimatePresence mode="wait" custom={dir}>
            ...
            >
              ...
              <blockquote
                className="font-mono text-white italic leading-relaxed mb-10"
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <div
                  className="relative rounded-full overflow-hidden border-2 border-gold/30 flex-shrink-0"
                ...
                <div>
                  ...
                  <div className="font-sans text-[9px] tracking-[0.3em] uppercase text-gold mt-0.5">
                    {t.role}
                  </div>
                </div>
              </div>
