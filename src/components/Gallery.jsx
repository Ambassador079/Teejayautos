...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="py-24 lg:py-36 bg-cream px-5 sm:px-8 xl:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div ref={ref} variants={stagger} initial="hidden" animate={inView ? 'show' : 'hidden'} className="mb-16">
          <motion.div variants={item} className="flex items-center gap-3 mb-4">
            ...
            <span className="font-sans text-[10px] tracking-[0.4em] uppercase text-gold">Gallery</span>
          </motion.div>
          ...
          {GALLERY.map(g => (
            ...
            >
              ...
              <div className="absolute bottom-0 inset-x-0 p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-350">
                <p className="font-sans text-[9px] tracking-[0.3em] uppercase text-white leading-tight">{g.caption}</p>
              </div>
              {/* Plus icon */}
        ...
        {sel && (
          ...
          >
            ...
            >
              ...
              />
              <p className="font-sans text-[9.5px] tracking-[0.38em] uppercase text-gold mt-4">{sel.caption}</p>
            </motion.div>
